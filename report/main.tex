...
\usepackage{graphicx}
\usepackage[dvipsnames]{xcolor} %per i colori
...
\begin{figure}[htpb] 
    \begin{myminipage}{0.45\textwidth} 
        \includegraphics[width=\textwidth]{res/charts/vanilla_scores.png} 
        \caption{DQN Training - Score}\label{fig:DQN - Score} 
    \end{myminipage} 
    \hspace{0.05\textwidth} 
    \begin{myminipage}{0.45\textwidth}  
        \includegraphics[width=\textwidth]{res/charts/vanilla_completions.png}
        \caption{DQN Training - Completions}\label{fig:DQN - Completions} 
    \end{myminipage}  
\end{figure}
...
Double DQN \cite{double-dqn} is a simple tweak to the basic method which consists in implementing a second neural network (called \textit{target network}) with the same architecture of the main one, which is used to predict the q-values for the training step, while the backpropagation is performed on the main network. This technique allows to reduce the Q-values overestimation problem which afflicts vanilla DQN.
...
\begin{figure}[htpb] 
\begin{myminipage}{0.45\textwidth} 
\includegraphics[width=\textwidth]{res/charts/dueling_scores.png} 
\caption{Dueling DQN Training - Scores}\label{fig:Score} 
\end{myminipage} 
\hspace{0.05\textwidth} 
\begin{myminipage}{0.45\textwidth}  
\includegraphics[width=\textwidth]{res/charts/dueling_completions.png}
\caption{Dueling DQN Training - Completions}\label{fig:Completions} 
\end{myminipage}  
\end{figure}
...
\begin{figure}[H]
        \centerline{\includegraphics[scale=.2]{res/charts/ppo_completions.png}}
...
\begin{figure}[H]
        \centerline{\includegraphics[scale=.2]{res/sweeps/sweep1.png}}
...
\begin{figure}[H]
        \centerline{\includegraphics[scale=.2]{res/sweeps/sweep2.png}}
